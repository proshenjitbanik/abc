...
module.exports.addEmployee = function (employeeData) {
    return new Promise(function (resolve, reject) {
        ...
        // Set the employeeNum property to the length of the "dataCollection.employees" array plus one
        employeeData.employeeNum = dataCollection.employees.length + 1;

        // Push the updated employeeData object onto the "dataCollection.employees" array
